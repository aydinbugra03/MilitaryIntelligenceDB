...
try {
    ...
    $supplies = $conn->query("SELECT supply_id, sup_name, quantity FROM Supply ORDER BY sup_name");
                            ...
                            <?php if ($supplies): ?>
                                <?php while ($supply = $supplies->fetch_assoc()): ?>
                                    <option value="<?php echo $supply['supply_id']; ?>">
                                        ID: <?php echo $supply['supply_id']; ?> - <?php echo $supply['sup_name']; ?> (Current: <?php echo $supply['quantity']; ?>)
                                    </option>
                                <?php endwhile; ?>
                            <?php endif; ?>
                        </select>
